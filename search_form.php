...
<div class="container">
  <div class="d-flex justify-content-center h-100">
    <div class="card"  style="height:28rem">
      ...
      <h3 class="mt-4">Employee search form</h3>
        ...
        <div class="card-body">
          ...
          <div class="input-group form-group">
            <div class="input-group-prepend">
             ...
             <input class="form-control" type ="text" name="code" placeholder="社員番号" value="">
          </div>
      ...
      <div class="card-footer">
        <div class="d-flex justify-content-center links">
          ...
          <button type="submit" class="btn float login_btn ml-4">検索</button>
        </div>
     </div>
     </form>
  </div>
...
<!--
  ...
  <table border="1">
      ...
      <tr>
        ...
        <td>
          <input type="hidden" name="gender" value="">
          <input type="radio" name="gender" value="1" required>男性<br>
          <input type="radio" name="gender" value="2" required>女性<br>
          <input type="radio" name="gender" value="0" required>不明
        </td>
      </tr>
    </table>
